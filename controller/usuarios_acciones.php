...
// 3) Pedimos los usuarios reales (antes esto era $usuariosEjemplo, un arreglo de mentira)
$usuarios = obtenerUsuarios($con);

// 4) Pedimos los roles reales, para llenar el <select> del formulario "Crear Usuario"
$roles = obtenerRoles($con);


// --- Funciones para pintar bonito (igual que antes, no cambian) ---
...
<div class="card card-round">
    <div class="card-body">
        ...
        <!-- Tabla de usuarios: ahora viene de la base de datos real -->
